                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-efe9a63db9b20f7f520d3450b81ebd0a"' : 'data-target="#xs-components-links-module-AppModule-efe9a63db9b20f7f520d3450b81ebd0a"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-efe9a63db9b20f7f520d3450b81ebd0a"' :
                                            'id="xs-components-links-module-AppModule-efe9a63db9b20f7f520d3450b81ebd0a"' }>
                                            <li class="link">
